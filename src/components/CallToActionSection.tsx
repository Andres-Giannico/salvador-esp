        ...
        <div className="relative overflow-hidden bg-gradient-to-r from-blue-600 to-sky-500 rounded-3xl p-8 md:p-12 shadow-xl">
          ...
          <div className="relative z-10 flex flex-col md:flex-row items-center justify-between">
            <div className="text-center md:text-left md:max-w-xl mb-8 md:mb-0">
              <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">¿Te apetece un día épico?</h2>
              <p className="text-blue-100 text-lg">
                Reserva hoy tu excursión con Salvador Ibiza y llévate recuerdos imborrables del Mediterráneo.
              </p>
            </div>
